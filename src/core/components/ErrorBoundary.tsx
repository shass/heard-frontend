...
/**
 * Survey Loading Error Boundary
 */
export function SurveyErrorBoundary({ children }: { children: ReactNode }) {
  return (
    <ErrorBoundary
...
/**
 * Access Control Error Boundary
 */
export function AccessControlErrorBoundary({ children }: { children: ReactNode }) {
  return (
    <ErrorBoundary
