...
ARG NEXT_PUBLIC_BRINGID_APP_ID

# Set environment variables for build
ENV NEXT_PUBLIC_API_URL=${NEXT_PUBLIC_API_URL}
ENV NEXT_PUBLIC_API_TIMEOUT=${NEXT_PUBLIC_API_TIMEOUT}
ENV NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID=${NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID}
ENV NEXT_PUBLIC_CDP_CLIENT_API_KEY=${NEXT_PUBLIC_CDP_CLIENT_API_KEY}
ENV NEXT_PUBLIC_APP_NAME=${NEXT_PUBLIC_APP_NAME}
ENV NEXT_PUBLIC_APP_VERSION=${NEXT_PUBLIC_APP_VERSION}
ENV NEXT_PUBLIC_ENVIRONMENT=${NEXT_PUBLIC_ENVIRONMENT}
ENV NEXT_PUBLIC_URL=${NEXT_PUBLIC_URL}
ENV NEXT_PUBLIC_FARCASTER_HEADER=${NEXT_PUBLIC_FARCASTER_HEADER}
ENV NEXT_PUBLIC_FARCASTER_PAYLOAD=${NEXT_PUBLIC_FARCASTER_PAYLOAD}
ENV NEXT_PUBLIC_FARCASTER_SIGNATURE=${NEXT_PUBLIC_FARCASTER_SIGNATURE}
ENV NEXT_PUBLIC_BRINGID_APP_ID=${NEXT_PUBLIC_BRINGID_APP_ID}
